...
.input:placeholder-shown {
  font-size: 0.5em;
    ...
    <label for="exampleInputEmail1" class="form-label"><small>Address</small></label>
    <textarea class="form-control" name="user_address" style="border-radius:4px;border-color: black; "  placeholder="Enter address" required></textarea>
